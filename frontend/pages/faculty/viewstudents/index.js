  ...
  return (
    <FacultyProtection setLoggedInFaculty={setLoggedInFaculty}>
      <div className={styles.container}>
        <Head>
          <title>
            Student Allocation Status | Faculty Dashboard | Automating Elective
            Processing
          </title>
                  ...
                  <table align="center">
                    <thead>
                      <tr>
                        ...
                        <th className={styles.courseCodeCell}>Name</th>
                        <th className={styles.courseNameCell}>Email</th>
                        <th className={styles.courseNameCell}>
                          Elective Assigned
                        </th>
                      </tr>
                    </thead>
